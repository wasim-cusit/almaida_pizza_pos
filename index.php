        ...
        <div class="header-left">
            <div class="branch-info">
                <div class="branch-logo">
                    ...
                    <span class="branch-name"><?php echo isset($_SESSION['branch_name']) && $_SESSION['branch_name'] ? htmlspecialchars($_SESSION['branch_name']) : 'Main Branch'; ?></span>
                </div>
            </div>
            <div class="order-info">
                <span>Order No: <?php echo $orderNumber; ?></span>
                <span>User: <?php echo htmlspecialchars($_SESSION['user_name']); ?></span>
